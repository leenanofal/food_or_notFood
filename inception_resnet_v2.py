...
from keras.layers import Dense, Dropout, Activation, Flatten, Convolution2D, MaxPooling2D, Input, Concatenate
...
class LeenaNet:
    ...
    def conv2d(x,filters, kernel_size,strides,padding):
        return Conv2D(filters=filters, kernel_size=kernel_size, strides=strides,padding=padding)(x) 
